...
public class LocationUtil extends Service implements LocationListener {
    ...
    private Location getLocation() {
        ...
        try {
            ...
            Log.d("TrackGPS",e.getLocalizedMessage());
        }
    ...
    public void showSettingsAlert(final String gps_title, String gps_message) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(mContext);
        alertDialog.setTitle(gps_title);
        alertDialog.setMessage(gps_message);
